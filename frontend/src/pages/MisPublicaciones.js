        ...
        <div className="container mx-auto p-4">
            ...
            <div className="flex justify-center mb-6">
                <Link to="/publicar-mascota" className="btn-primary btn-icon">
                    <PlusCircleIcon className="w-5 h-5 mr-2" /> Publicar Nueva Mascota
                </Link>
            </div>
            ...
            {misMascotas.length === 0 ? (
                <div className="bg-white p-6 rounded-lg shadow-md text-center">
                    ...
                    <Link to="/publicar-mascota" className="btn-primary">
                    ...
                    {misMascotas.map(mascota => (
                        <div key={mascota.id} className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                            ...
                            <div className="p-4 border-t border-gray-200 flex justify-around space-x-2">
                                <button className="flex-1 btn-primary btn-icon text-sm" onClick={() => handleEditClick(mascota)}>
                                    <FontAwesomeIcon icon={faEdit} className="mr-2" /> Editar
                                </button>
                                <button className="flex-1 btn-danger btn-icon text-sm" onClick={() => handleDeleteClick(mascota.id)}>
